...
type
  TPacketEditor = class(TForm)
    ...
    Label3: TLabel;
    GroupBox4: TGroupBox;
    edDelimSymbols: TEdit;
    Label4: TLabel;
    ChkEndString: TCheckBox;
    cbTwoDelimAsEmptVal: TCheckBox;
    GroupBox5: TGroupBox;
    Label7: TLabel;
    edActivatingStr: TEdit;
    GroupBox6: TGroupBox;
    Label8: TLabel;
    edDeactivatingStr: TEdit;
    cbAutoClose: TCheckBox;
  end;

function EditPacket(Packet:TApdDataPacket; FormStorage: TFormStorage):Boolean;
...
begin
  ...
  with PacketEditor do
    try
      ...
      EdtStartString.Text := FormStorage.StoredValue['PackedStartString'];
      EdtEndString.Text := FormStorage.StoredValue['PackedEndString'];
      ...
      edDelimSymbols.Text := FormStorage.StoredValue['DelimSymbols'];
      edActivatingStr.Text := FormStorage.StoredValue['ActivatingStr'];
      edDeactivatingStr.Text := FormStorage.StoredValue['DeactivatingStr'];
      cbTwoDelimAsEmptVal.Checked := FormStorage.StoredValue['TwoDelimAsEmptVal'];
      cbAutoClose.Checked := FormStorage.StoredValue['AutoCloseComport'];
      repeat
        Ok := True;
        if ShowModal = mrOk then
          try
            ...
            FormStorage.StoredValue['PackedStartString'] := EdtStartString.Text;
            FormStorage.StoredValue['PackedEndString'] := EdtEndString.Text;

            FormStorage.StoredValue['DelimSymbols'] := edDelimSymbols.Text;
            FormStorage.StoredValue['ActivatingStr'] := edActivatingStr.Text;
            FormStorage.StoredValue['DeactivatingStr'] := edDeactivatingStr.Text;
            FormStorage.StoredValue['TwoDelimAsEmptVal'] := cbTwoDelimAsEmptVal.Checked;
            FormStorage.StoredValue['AutoCloseComport'] := cbAutoClose.Checked;
